...
void MasterLogic::startDemo(void) {
	...
	std::shared_ptr<Item> testItem1 = std::make_shared<Item>(ActorType::HEALTH, 250, 250, 20, 20, 1, false);
	...
	std::shared_ptr<Item> testItem3 = std::make_shared<Item>(ActorType::HEALTH, 350, 250, 20, 20, 1, false);
