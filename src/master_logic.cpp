...
void MasterLogic::startDemo(void) {
    ...
    // Add test items
    this->roomList.front()->addActor(std::make_shared<MeleeWeapon>(480, 350, 40, 60, 10, 2, this->getCurrentRoom()->getFred()));
    this->roomList.front()->addActor(std::make_shared<RangeWeapon>(150, 150, 60, 30, 10, 2, this->getCurrentRoom()->getFred()));
